...
//components
import ongoingShift from '@/views/accessNursePages/preferenceOngoingShift.vue'
//configurations
...
describe('ongoingShift',()=> {
    let cmp
    let vm

    beforeEach(() => {
        cmp = shallowMount(ongoingShift, {localVue, mocks: {$route, $router}})
        vm = cmp.vm
        // jest.resetModules();
        // jest.clearAllMocks();
    })
