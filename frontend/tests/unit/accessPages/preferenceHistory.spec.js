...
//components
import shiftPreferenceHistory from '@/views/accessNursePages/preferenceHistory.vue'
//configurations
...
describe('preferenceHistory',()=> {
    let cmp
    let vm

    beforeEach(() => {
        cmp = shallowMount(shiftPreferenceHistory, {localVue, mocks: {$route, $router}})
        vm = cmp.vm
        // jest.resetModules();
        // jest.clearAllMocks();
    })
