<template>
    <div style="height:100%;overflow: scroll">
        <el-row class="nurse-header-span">Shift Preference</el-row>
...
<script>
    // import typeAndTypeSelectionBox from '../components/typeAndTypeSelectionBox'
    ...
    export default {
            ...
            return {
                ...
                pickerOptionsPreference: {
                    disabledDate: (time) => {
                        ...
                        return this.disableDate.indexOf(time.getTime()) !== -1 || time.getTime() < Date.now() - 3600 * 1000 * 24;
        ...
        methods: {
            ...
            requestDisableDate() {
                this.$axios.get(
                    this.siteConfig.serve.requestPreference + '?nurse_username=' + this.nurseName
