...
<template>
    <div class="container">
        <h3 style="margin-top: 20px">Shift Preference History</h3>
...
<script>
    export default {
        ...
        mounted(){
            // this.negativeThreshold = this.siteUtils.requestNegativeThreshold(this);
            // this.tableHeight =
            this.renderTable();
        },
        computed:{
        ...
        methods: {
            async renderTable(){
                ...
                //this part request all preferences up to today
                this.$axios.get(this.siteConfig.baseApi+'/api/preferences?$sort[shift_date]=-1&shift_date[$lt]='+startTimeUTC,
                    {
