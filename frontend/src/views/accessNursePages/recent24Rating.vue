...
<template>
    <div class="container">
        <h3 style="margin-top: 20px">Rate 24 Hours</h3>
...
<!--        </data-tables>-->
        <el-table ref="table"
                  border
                  :default-sort = "{prop:'general_score', order:'descending'}"
                  :data="rateTable"
...
<script>
    export default {
        ...
        methods: {
            ...
            geturl(str1,str2){
                return (this.siteConfig.serve.queryRate+'$sort[shift_date]=-1&shift_date[$gt]='+str1+'&shift_date[$lt]='+str2);
            },
            questRatingStandard(){
            ...
            renderTable(){
                ...
                let nowTimeUTC = timeLocal.valueOf()
                let pastTimeUTC = nowTimeUTC - 86390000 *2;
                let finalurl = this.geturl(pastTimeUTC,nowTimeUTC)
